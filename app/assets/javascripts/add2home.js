...
var addToHome = (function (w) {
	...
	var nav = w.navigator,
		isIDevice = 'platform' in nav && (/iphone|ipod|ipad|Linux armv7l/gi).test(nav.platform),
		isIPad,
		isRetina,
		isSafari,
		isStandalone,
	...
	function loaded () {
        ...
        if (nav.platform == "Linux armv7l") {
          options.message = 'Install this web app on your Android: select options and then <strong>Add to Home Screen</strong>.';
        }
